...
contract DocumentSign is AccessControl, ReentrancyGuard{
    ...
    function calculateProposalId(uint _number, address _creator, uint _time, bytes32 _description, bytes32 _merkleRoot, uint _signersAmount)public pure returns(bytes32){
        return keccak256(abi.encode(
            _number, _creator, _time, _description, _merkleRoot, _signersAmount
        ));
    }
} 
